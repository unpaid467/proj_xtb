...
const ALL_ETFS = [
    ...
    { symbol: 'MISL',      stooqSymbol: 'misl.uk',       portfolio: 'Mamus',       currency: 'USD' },
    { symbol: 'SEC0',      stooqSymbol: 'sec0.de',       portfolio: 'Mamus',       currency: 'EUR' },
    { symbol: 'CNDX',      stooqSymbol: 'cndx.uk',       portfolio: 'Mamus',       currency: 'USD' },
...
async function main() {
    ...
    else if (histOk === 'skip') warn('Endpoint CSV wymaga sesji przeglądarki');
